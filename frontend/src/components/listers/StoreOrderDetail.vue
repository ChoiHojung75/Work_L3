<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Telnum" v-model="item.telnum" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="Orderststus" v-model="item.orderststus" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
